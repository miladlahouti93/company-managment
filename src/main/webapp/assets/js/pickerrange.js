...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['src/main/webapp/assets/js/plugins/daterangepicker/moment', 'jquery', 'exports'], function(momentjs, $, exports) {
      root.daterangepicker = factory(root, exports, momentjs, $);
    });

  } else if (typeof exports !== 'undefined') {
    var momentjs = require('src/main/webapp/assets/js/plugins/daterangepicker/moment');
    var jQuery;
    try {
