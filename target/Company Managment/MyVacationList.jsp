                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form action="<%=request.getContextPath()%>/myVacations" method="post">
                                <!-- /.card-header -->
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-hover">
                                        <tr>
                                            <th> شماره درخواست مرخصی</th>
                                        ...
                                        <c:forEach items="${MyVacations}" var="vacationitem">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href='<%=request.getContextPath()%>/rest/employee/deleteVacation/${vacationitem.vacationID}'>حذف درخواست</a></td>
                                            </tr>
