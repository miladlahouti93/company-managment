...
<div class="container" style="max-width: 500px;">
    ...
    <form action="rest/employee/addVacation" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="exampleInput1"  name="VacationStartDate" placeholder="تاریخ شروع مرخضی" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="toDate1" name="VacationEndDate"  placeholder="تاریخ پایان مرخصی" data-MdDateTimePicker="true" data-trigger="click" data-targetselector="#toDate1" data-groupid="group1" data-todate="true" data-enabletimepicker="true" data-placement="right" />
        </div>
    </div>

        <div style="margin: 20px; clear: both;"></div>
        <button class="btn btn-primary btn-lg btn-block" type="submit" > ثبت مرخصی </button>
        </form>
